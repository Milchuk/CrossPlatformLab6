...
export default class PollListItem extends React.Component{
  ...
  render() {
      ...
      let {letters, question, votes, days, link, delItemFunction} = this.props
      return (
        ...
        <Wrapper>
          <PollLetters>{letters}</PollLetters>
            <Container>
                ...
                <ContainerColumn>
                    <Label>Data</Label>
                    <SecondaryText>{days} ago</SecondaryText>
                </ContainerColumn>
                <ContainerColumn>
                    <Label>Votes</Label>
                    <SecondaryText>{votes} users</SecondaryText>
                </ContainerColumn>
                
                <div>
                    <SvgFilter color={colors.black} onClick={()=>{navigator.clipboard.writeText(window.location+"poll/:"+link)}} 
                    ...
                    <SvgFilter color={colors.error} onClick={()=>{delItemFunction(this.props.id)}} 
                    width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
